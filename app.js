...
mongoose.connect("mongodb+srv://sanket:<mongodb#321>@cluster0-ko4be.mongodb.net/test?retryWrites=true&w=majority", { useNewUrlParser: true }); // connected to yelp_camp_v7 database
